...
function renderAddcontactsOverlay() {
    ...
    overlay.innerHTML += /*html*/` <div class="add-new-contact-section d-none" id="newcontactformsection" onclick="closeForm()">
            ...
            <div class="add-new-contact-form">
                ...
                <div class="form-buttons">
                    ...
                    <div class="dark-btn create-contact-btn"
                        onclick="validateContact(), renderContacts()" type="submit">
                        <p>Create Contact</p>
